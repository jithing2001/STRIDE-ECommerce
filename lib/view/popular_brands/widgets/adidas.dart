...
class AdidasClass extends StatelessWidget {
  const AdidasClass({super.key});
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return InkWell(
                ...
                child: HomeGridView(
                    imgPath: imagePath[index], productName: productName[index],productRate: productRate[index]),
              );
            },
            itemCount: 4,
          ),
